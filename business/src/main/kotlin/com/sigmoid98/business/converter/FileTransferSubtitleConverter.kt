...
@KComponent
interface FileTransferSubtitleConverter {

    fun toDto(vo: FileTransferSubtitle): FileTransferSubtitleQueryResp

    fun toDtoList(voList: List<FileTransferSubtitle>): List<FileTransferSubtitleQueryResp>
}