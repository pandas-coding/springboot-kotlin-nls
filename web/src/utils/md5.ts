 ...
 */
export function hexMd5Key(s: string) {
  return hexMd5(s + KEY);
}
...
// @ts-ignore
function hex_hmac_md5(key: string, data: string) {
  return binl2hex(core_hmac_md5(key, data));
}

// @ts-ignore
function b64_hmac_md5(key: string, data: string) {
  return binl2b64(core_hmac_md5(key, data));
}

// @ts-ignore
function str_hmac_md5(key: string, data: string) {
